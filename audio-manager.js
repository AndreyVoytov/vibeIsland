(function (global) {
  const sounds = {
    ...
    'ambience.campfire': ['./audio/ambience/campfire-loop.ogg'],
    'ambience.lighthouse': ['./audio/ambience/lighthouse-loop.ogg'],
    'player.footstep': [
      './audio/player/footstep-grass-01.ogg',
      './audio/player/footstep-grass-02.ogg',
      './audio/player/footstep-grass-03.ogg',
      './audio/player/footstep-grass-04.ogg',
    ],
    'player.axeSwing': [
      './audio/player/axe-swing-01.ogg',
      './audio/player/axe-swing-02.ogg',
      './audio/player/axe-swing-03.ogg',
    ],
    'player.axeHitBush': [
    ...
    'player.leavesBurst': [
      './audio/player/leaves-burst-01.ogg',
      './audio/player/leaves-burst-02.ogg',
      './audio/player/leaves-burst-03.ogg',
    ],
    'water.ripple': [
